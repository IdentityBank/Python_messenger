...
versionString = "0.0.1"
applicationNameString = "messengerserver"
applicationDescriptionString = "Messenger request server - server interface for messenger"
...
def action(args):
    server = MessengerServer(args['jscConfigFilePath'].name, args['connectionName'])
